...
- `OP_PUSHBYTES_3 070040 OP_CSV OP_DROP` part ensures that needed amount of time is passed. Specifically `07` part of `070040` bytes says that it's locked for 1 hour.  for how it's evaluated.
...
```swift
dependencies: [
    .package(url: "https://github.com/curdicu/Hodler.git", .upToNextMajor(from: "1.0.0"))
]
```
